...
export const VOICE = {
  ...
  reentry: {
    ...
    body: "Today's command is lighter. Return to the mission.",
    cta: 'Return to mission',
  },

  /** Empty states */
  empty: {
    notes: 'No repair data yet. Complete your first diagnosis to unlock the repair library.',
    commands: 'Your command for today is being drawn up. One moment.',
    mocks: 'No baseline signal yet. Your first mock will reveal where marks are leaking.',
    review: 'Your first recovery review is sealed on Sunday night. Work the week; the verdict will come.',
  },

  /** Errors — fierce at the system, never the aspirant */
  error: {
    generic: 'The system could not complete this step. Your progress is safe. Try once more.',
  ...
  brandLines: {
    ...
    diagnosis: 'Thirty premium cards free. Fifty for the full diagnosis. The system maps the aspirant before the syllabus.',
  },
} as const
